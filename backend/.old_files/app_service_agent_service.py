...
NOTE: This service uses the legacy routing system and should be migrated
to use LinearGraphFactory and AI Planner for new implementations.
For new workflows, use LangGraphService.execute_task_with_ai_planner() instead.
"""
import logging
import os
...
from app.agents.nodes import planner_node, invoice_agent_node,  hitl_agent_node
