...
- [ ] 3. Update Agent Service for HITL Routing
...
- [ ] 4. Implement Clarification Response Handler
  ...
  - If revision: loop back to Planner with context
...
- [ ] 5. Add Optional HITL Configuration
...
- [ ] 6. Implement Frontend Clarification UI
...
- [ ] 7. Add Clarification Message Handler in Frontend
...
- [ ] 8. Implement Clarification Response Submission
...
- [ ] 10. End-to-End Testing
  - Test complete flow: Task → Specialized Agent → HITL → Approval → Complete
  - Test revision loop: Task → Specialized Agent → HITL → Revision → Loop → Complete
